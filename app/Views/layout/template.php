...
<html lang="en">
  <head>
	...
	<body class="nav-md">
				...
				<div class="col-md-3 left_col">
					<div class="left_col scroll-view">
						<div class="navbar nav_title" style="border: 0; display: inline-block; display: flex; justify-content: center;">
							...
							<a href="index.html" class="site_title" style="width: auto;"><span>DITMAWA</span></a>
						</div>
		...
		<!-- cdn untuk ckeditor terbaru -->
		<script src="https://cdn.ckeditor.com/ckeditor5/35.1.0/super-build/ckeditor.js"></script>
		<!-- akhir cdn ckeditor terbaru -->
		...
		<!-- <script>
			ClassicEditor
				.create( document.querySelector( '#halaman_isi' ) )
				.catch( error => {
					console.error( error );
				} );
		</script>
		<script>
			ClassicEditor
				.create( document.querySelector( '#berita_isi' ) )
				.catch( error => {
					console.error( error );
				} );
		</script>
		<script>
			ClassicEditor
				.create( document.querySelector( '#vp_deskripsi' ) )
				.catch( error => {
					console.error( error );
				} );
		</script>
		<script>
			ClassicEditor
				.create( document.querySelector( '#prestasi_deskripsi' ) )
				.catch( error => {
					console.error( error );
				} );
		</script> -->

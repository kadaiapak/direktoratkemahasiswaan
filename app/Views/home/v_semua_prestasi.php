                    ...
                    <div class="blog-content col-md-10 col-md-offset-1">
                        <div class="item-box">
                            <div class="item">
                                <div class="info">
                                    <h3>
                                        Prestasi Mahasiswa Tahun 2024
                                    </h3>
                                    <div class="meta">
                                    </div>
                                    <p>
                                        Berikut daftar prestasi mahasiswa tahun 2024
                                    </p>
                                    
                                    <p style="margin-top: 20px;">
                                        Demikian dijabarkan prestasi mahasiswa tahun 2024, semoga bisa menjadi pedoman dalam pelaksanaan nantinya.
                                    </p>
                                    <blockquote>

                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
									...
									<table id="datatable" class="table table-bordered">
										...
										<tbody>
                                        	<?php $no = 1 ?>
											<?php foreach($semua_gambar as $sb): ?>
											<tr>
												<td class=" "><?= $no; ?></td>
												<td class=" "><img style="width: 50px; height: 50px;" src="<?= base_url('/image_manager/'.$sb['gambar_nama']); ?>" alt=""></td>
												<td class=" last">
													<input type="text" hidden value="<?= base_url('image_manager/'.$sb['gambar_nama']); ?>" id="myInput">
													<button class="btn btn-success btn-md" onclick="myFunction()">Copy Gambar</button>
